...
const ProjectCard = ({imgUrl, title, desc, gitUrl, prevUrl, type}) => {
  return (
    <div>      
          ...
          style={{background:`url(${imgUrl})`, backgroundSize: "cover"}}>
        {
          type === "public" &&
            <div className={`overlay items-center justify-center rounded-t-xl absolute top-0 left-0 right-0 w-full h-full bg-[#232323] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-75 transition-all duration-500`}>
              <Link href={""} className="h-10 w-10 sm:h-12 sm:w-12 border-[#ADB7BE] hover:border-white relative rounded-full border-2 group/link">
              ...
              <Link href={""} className="h-10 sm:h-12 sm:w-12 w-10 ml-8 border-[#ADB7BE] hover:border-white relative rounded-full border-2 group/link">
        ...
        <div className='text-white rounded-b-xl bg-[#232323] px-2 pb-3 pt-2'>
